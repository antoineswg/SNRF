...
function updateDisplay(data) {
    ...
    document.querySelector('.deprog2020 .logoDeprog').innerHTML = '<img src="images/logosLignes/' + ligneActive + 'Logo.png" alt=""></img>';
    ...
    document.querySelector('.deprog2021 .logoDeprog').innerHTML = '<img src="images/logosLignes/' + ligneActive + 'Logo.png" alt=""></img>';
    ...
    document.querySelector('.deprog2022 .logoDeprog').innerHTML = '<img src="images/logosLignes/' + ligneActive + 'Logo.png" alt=""></img>';
    ...
    document.querySelector('.deprog2023 .logoDeprog').innerHTML = '<img src="images/logosLignes/' + ligneActive + 'Logo.png" alt=""></img>';
    ...
    document.querySelector('.deprogMoyenne .logoDeprog').innerHTML = '<img src="images/logosLignes/' + ligneActive + 'Logo.png" alt=""></img>';
